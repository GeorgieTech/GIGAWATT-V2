...
**Current release: [V2.2.27](https://github.com/GeorgieTech/GIGAWATT-V2/releases/tag/v2.2.27)** (`v2.2.27`). Previous: [V2.2.26](https://github.com/GeorgieTech/GIGAWATT-V2/releases/tag/v2.2.26) · [V2.2.25](https://github.com/GeorgieTech/GIGAWATT-V2/releases/tag/v2.2.25).
