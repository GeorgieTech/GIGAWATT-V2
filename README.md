...
**Current release: [V2.2.13](https://github.com/GeorgieTech/GIGAWATT-V2/releases/tag/v2.2.13)** (`v2.2.13`). Previous: [V2.2.12](https://github.com/GeorgieTech/GIGAWATT-V2/releases/tag/v2.2.12) · [V2.2.11](https://github.com/GeorgieTech/GIGAWATT-V2/releases/tag/v2.2.11).
