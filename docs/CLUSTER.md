...
| V2.2.23 | Merge #3–#6: hide waveform chrome, EQ in Settings (4-tab bar), library auto-analyze, no-cover visualizer. |
| V2.2.24 | Library first-load: do not JSON-parse waveforms to list tracks; cache catalog; show local tracks immediately. |
