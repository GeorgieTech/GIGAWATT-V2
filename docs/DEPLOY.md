...
It must print `2.2.29`. AirPlay binaries land in `/data/opt/airplay`. Pulse default is 48 kHz (Beta2). Do not open TOSLINK at 44.1 kHz — that rate is silent on this jack. Bottom tabs are taller with 13px labels. Play/pause is an icon.
