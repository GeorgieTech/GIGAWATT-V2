...
It must print `2.2.35`. NAS artist names show in full. Library shows a lyrics progress bar for tracks on this disk. NAS lyrics stay on-demand (Karaoke → Fetch).
